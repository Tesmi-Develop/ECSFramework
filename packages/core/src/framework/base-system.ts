...
import jecs, { Entity, Id, Query } from "@rbxts/jecs";
import { ECSFramework } from ".";
import { DestroyComponent } from "./components/destroyed-component";
import { Calculate, createQuery, ExtractQueryTypes, query, QueryHandle, ToIds } from "./flamecs";
import {
	add,
	added,
	changed,
...
import { CreateQueryChanged } from "./jecs-utils/query-changed";
import { queryChanged } from "./hooks/query-changed";
...
export abstract class BaseSystem {
	 ...
	 * @metadata macro
	 */
	public AddPairRuntime<T extends Pair<Tag>>(
		entity: Entity,
		object: Entity,
		key?: ComponentKey<ExtractPredicate<T>> | string,
	): void {
		return add(this.world, entity, object, key as never);
	}
	 ...
	 * @metadata macro
	 */
	public AddPairStatic<T extends Pair<Tag, defined>>(entity: Entity, key?: ResolveKey<T> | string): void {
		return add(this.world, entity, key as never);
	}
	 ...
	 * @metadata macro
	 */
	public AddComponent<T extends Tag>(entity: Entity, key?: ComponentKey<T> | string): void {
		return add(this.world, entity, key as never);
	}
	 ...
	 * @metadata macro
	 */
	public SetPairRuntime<T extends Pair<defined>>(
		entity: Entity,
		object: Entity,
		value: ResolveValue<T>,
		key?: ComponentKey<ExtractPredicate<T>> | string,
	) {
		return set(this.world, entity, object, value, key as never);
	}
	 ...
	 * @metadata macro
	 */
	public SetPairStatic<T extends Pair<defined, defined>>(
		entity: Entity,
		value: ResolveValue<T>,
		key?: ResolveKey<T>,
	) {
		return set(this.world, entity, value as never, key as never);
	}
	 ...
	 * @metadata macro
	 */
	public SetComponent<T>(entity: Entity, value?: Unwrap<T>, key?: ComponentKey<T> | string): void;
	 ...
	 * @metadata macro
	 */
	public SetComponent<T>(entity: Entity, value: Partial<T>, key?: ComponentKey<T> | string): void;
	...
	public MutateComponent<T>(
		...
		key?: ComponentKey<T> | string,
	): void {
		if (this.isTagComponent(this.GetClassComponent(key))) {
	 ...
	 * @metadata macro
	 */
	public RemovePairRuntime<T extends Pair<defined>>(
		entity: Entity,
		object: Entity,
		key?: ComponentKey<ExtractPredicate<T>> | string,
	): void {
		return remove(this.world, entity, object, key as never);
	}
	 ...
	 * @metadata macro
	 */
	public RemovePairStatic<T extends Pair<defined, defined>>(entity: Entity, key?: ResolveKey<T>) {
		return remove(this.world, entity, key as never);
	}
	 ...
	 * @metadata macro
	 */
	public RemoveComponent<T>(entity: Entity, key?: ComponentKey<T> | string): void {
		return remove(this.world, entity, key as never);
	}
	 ...
	 * @metadata macro
	 */
	public GetPairRuntime<T extends Pair<defined>>(
		entity: Entity,
		object: Entity,
		key?: ComponentKey<ExtractPredicate<T>> | string,
	): ResolveValue<T> | undefined {
		return get(this.world, entity, object, key as never);
	}
	...
	public GetComponent<T>(entity: Entity, key?: ResolveKey<T>): ResolveValue<T> | undefined {
		return get(this.world, entity, key as never) as ResolveValue<T> | undefined;
	}
	 ...
	 * @metadata macro
	 */
	public HasPairRuntime<T extends Pair<defined>>(
		entity: Entity,
		object: Entity,
		key?: ComponentKey<ExtractPredicate<T>> | string,
	): boolean {
		return has(this.world, entity, object, key as never);
	}
	...
	public HasComponent<T>(entity: Entity, key?: ResolveKey<T>): boolean {
		return has(this.world, entity, key as never);
	}
	 ...
	 * @metadata macro
	 */
	public TargetComponent<T>(entity: Entity, key?: ComponentKey<T> | string): Entity | undefined {
		return target(this.world, entity, key as never);
	}
	...
	/** @metadata macro */
	public GetClassComponent<T>(key?: ComponentKey<T> | string) {
	 ...
	 * @metadata macro
	 */
	public Added<T>(key?: ComponentKey<T> | string): Signal<[entity: Entity<T>, data: T]> {
		return added(this.world, key as ComponentKey<T>);
	}
	 ...
	 * @metadata macro
	 */
	public Removed<T>(key?: ComponentKey<T> | string): Signal<[entity: Entity<T>]> {
		return removed(this.world, key as ComponentKey<T>);
	}
	 ...
	 * @metadata macro
	 */
	public Changed<T>(key?: ComponentKey<T> | string): Signal<[entity: Entity<T>, data: T, prevData: T]> {
		return changed(this.world, key as ComponentKey<T>);
	}
	...
	/** @metadata macro */
	public QueryChange<T>(componentTypeId?: ComponentKey<T> | string, key?: Modding.Caller<"uuid">) {
		return QueryChange<T>(componentTypeId! as ComponentKey<T>, key!);
	}

	/** @metadata macro */
	public QueryChanged<T extends Array<unknown> = []>(
		terms?: ToIds<Calculate<T>["query"]>,
		filterWithout?: ToIds<Calculate<T>["without"]>,
		filterWith?: ToIds<Calculate<T>["with"]>,
		key?: Modding.Caller<"uuid">,
	) {
		return queryChanged(terms, filterWithout, filterWith, key) as never as IterableFunction<LuaTuple<[Entity]>>;
	}
