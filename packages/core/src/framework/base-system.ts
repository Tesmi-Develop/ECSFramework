...
export abstract class BaseSystem {
	...
	public MutateComponent<T>(
		...
		const classComponent = this.GetClassComponent(key as ComponentKey<unknown>);
		if (classComponent && this.isTagComponent(classComponent)) {
	...
	public GetClassComponent<T>(key?: ComponentKey<T> | string) {
		return this.framework.ComponentsMap.get(key!);
	}
	...
	public OnUpdate(deltaTile: number) {}
	public OnEffect() {}
	//#endregion
}
